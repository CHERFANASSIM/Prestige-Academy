...
public class ConnexionController implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4407493692325924259L;
	@Inject
	...
	public void EntrepriseConnecte() {
		HttpSession session = (HttpSession) FacesContext.getCurrentInstance().getExternalContext().getSession(false);
		session.setAttribute("entrepriseID", entrepriseConnecte.getEntrepriseID());
	}
	...
	public String seConnecterStagiaire() {
		Stagiaire stagiaireSeConnecte = stagiaireService.seConnecter(mailStagiaire, mdpStagiaire);
		String redirection = "";
	...
	public String seConnecterEntreprise() {
		Entreprise entrepriseSeConnecte = entrepriseService.seConnecter(mailEntreprise, mdpEntreprise);
		String redirection = "";
    	...
    	setListeProcessRecru(entreprisesService.rechercheLesRecrutements(e.getEntrepriseID()));
